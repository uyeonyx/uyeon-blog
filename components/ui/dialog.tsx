    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'backdrop-blur-3xl',
          'shadow-2xl shadow-gray-900/20 dark:shadow-primary-500/20',
          // 그라데이션 오버레이
          'before:absolute before:inset-0 before:rounded-2xl before:bg-linear-to-b before:from-white/60 before:to-transparent before:pointer-events-none dark:before:from-white/10',
          // 열림/닫힘 애니메이션
          'data-[state=open]:animate-in data-[state=closed]:animate-out',
          'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
          'data-[state=closed]:zoom-out-96 data-[state=open]:zoom-in-100',
          'data-[state=closed]:slide-out-to-top-[4%] data-[state=open]:slide-in-from-bottom-[4%]',
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100', className)}
      {...props}
    />
  )
}
